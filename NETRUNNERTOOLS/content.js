...
async function loadModeFromStorage() {
  try {
    ...
    currentMode = result.netrunner_translate_mode || 'zh_only';
...
chrome.runtime.onMessage.addListener(async (request, sender, sendResponse) => {
  switch (request.action) {
    case 'zh_only':
      await translatePage('zh_only');
      break;
    case 'bilingual':
      await translatePage('bilingual');
      break;
    case 'restore':
      await translatePage('restore');
      break;
  }
